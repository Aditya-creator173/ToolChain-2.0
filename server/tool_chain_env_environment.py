...
from tool_chain_env.models import ToolChainAction, ToolChainObservation, State
from tool_chain_env.server import mock_api
...
class ToolChainEnvironment:
    ...
    def reset(self, seed: int | None = None) -> ToolChainObservation:
        ...
        from tool_chain_env.server import mock_api as _mock_api
